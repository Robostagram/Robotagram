...
class TestRobotPositionGeneration extends Specification with Mockito{
  ...
  "generate random position " should {
      ...
      mock[controllers.Application].getRandomPosition(anyInt) returns 7 thenReturns 7 thenReturns 7 thenReturns 8 thenReturns 8 thenReturns 7 thenReturns 8 thenReturns 8
