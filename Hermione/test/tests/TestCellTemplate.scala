...
class TestCellTemplate extends Specification {
  "render cell template" in {
    var html = views.html.cell(EmptyCell.withLeft(true), null, new Goal(Color.Red, Symbol.Star))
    contentType(html) must equalTo("text/html")
    contentAsString(html) must contain("wall-left")

    html = views.html.cell(EmptyCell.withRight(true), null, new Goal(Color.Red, Symbol.Star))
    contentAsString(html) must contain("wall-right")

    html = views.html.cell(EmptyCell.withTop(true), null, new Goal(Color.Red, Symbol.Star))
    contentAsString(html) must contain("wall-top")

    html = views.html.cell(EmptyCell.withBottom(true), null, new Goal(Color.Red, Symbol.Star))
    contentAsString(html) must contain("wall-bottom")
  }

  "render red star in cell template" in {
    val html = views.html.cell(EmptyCell.withGoal(new Goal(Color.Red, Symbol.Star)), null, new Goal(Color.Red, Symbol.Star))
  ...
  "render blue gear in cell template" in {
    val html = views.html.cell(EmptyCell.withGoal(new Goal(Color.Blue, Symbol.Gear)), null, new Goal(Color.Red, Symbol.Star))
  ...
  "render yellow planet in cell template" in {
    ...
    val html = views.html.cell(EmptyCell.withGoal(new Goal(Color.Yellow, Symbol.Planet)), null, new Goal(Color.Red, Symbol.Star))
  ...
  "render green moon in cell template" in {
    val html = views.html.cell(EmptyCell.withGoal(new Goal(Color.Green, Symbol.Moon)), null, new Goal(Color.Red, Symbol.Star))
  ...
  "render blue sun in cell template" in {
    val html = views.html.cell(EmptyCell.withGoal(new Goal(Color.Blue, Symbol.Sun)), null, new Goal(Color.Red, Symbol.Star))
  ...
  "render robot in cells" in {
    val html = views.html.cell(EmptyCell, new Robot(Color.Red, 0, 12), new Goal(Color.Red, Symbol.Star));
    contentType(html) must equalTo("text/html")
    contentAsString(html) must contain("robot")
    contentAsString(html) must contain("red")
  }
  "do not render robot in cells" in {
    val html = views.html.cell(EmptyCell, null, new Goal(Color.Red, Symbol.Star));
